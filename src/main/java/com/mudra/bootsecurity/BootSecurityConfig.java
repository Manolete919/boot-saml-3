...
/*
 * Change : With Spring Boot 3 and Spring Security 6.0 - We dont need to extend
 * WebSecurityConfigurerAdapter anymore. Also, Spring Boot SAML integration now uses
 * OpenSAML 4 because of which there are changes to classes being used and also
 * the pom.xml file to include the opensaml 4 jars.
 */
@Configuration
